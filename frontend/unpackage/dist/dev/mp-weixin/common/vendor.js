...
function populateParameters(result) {
  ...
  var parameters = {
    appId: "__UNI__KITCHEN",
    appName: "my-chicken-kitchen",
    appVersion: "1.0.0",
    appVersionCode: "1",
...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"my-chicken-kitchen","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 26 */
/*!**********************************************!*\
  !*** E:/AI/code/chicken/frontend/pages.json ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 33 */
/*!**************************************************!*\
  !*** E:/AI/code/chicken/frontend/store/index.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var store = new _vuex.default.Store({
  ...
  actions: {
    ...
    setUserId: function setUserId(_ref3, userId) {
...
/* 52 */
/*!**************************************************!*\
  !*** E:/AI/code/chicken/frontend/api/kitchen.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = void 0;
var _request = _interopRequireDefault(__webpack_require__(/*! ../http/request.js */ 53));
var _default = {
  listFridge: function listFridge(userId) {
    return _request.default.get('/kitchen/fridge', {
      userId: userId
    });
  },
  addFridge: function addFridge(data) {
    return _request.default.post('/kitchen/fridge', data);
  },
  updateFridge: function updateFridge(userIngredientId, data) {
    return _request.default.put("/kitchen/fridge/".concat(userIngredientId), data);
  },
  deleteFridge: function deleteFridge(userIngredientId, userId) {
    return _request.default.delete("/kitchen/fridge/".concat(userIngredientId), {
      userId: userId
    });
  },
  fridgeRecommendations: function fridgeRecommendations(userId) {
    return _request.default.get('/kitchen/fridge/recommendations', {
      userId: userId
    });
  },
  homeRecipes: function homeRecipes() {
    var limit = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 20;
    return _request.default.get('/kitchen/home-recipes', {
      limit: limit
    });
  },
  categories: function categories() {
    return _request.default.get('/kitchen/categories');
  },
  recipesByCategory: function recipesByCategory(categoryId) {
    var limit = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 20;
    return _request.default.get('/kitchen/recipes', {
      categoryId: categoryId,
      limit: limit
    });
  },
  recipeDetail: function recipeDetail(recipeId) {
    return _request.default.get("/kitchen/recipes/".concat(recipeId));
  }
};
exports.default = _default;
...
/* 53 */
/*!***************************************************!*\
  !*** E:/AI/code/chicken/frontend/http/request.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { (0, _defineProperty2.default)(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
var BASE_URL = 'http://127.0.0.1:8989/api';
...
var _default = {
  ...
  put: function put(url, data, header) {
    return request({
      url: url,
      method: 'PUT',
      data: data,
  ...
  delete: function _delete(url, data, header) {
    return request({
      url: url,
      method: 'DELETE',
      data: data,
...
/* 86 */
/*!***********************************************!*\
  !*** E:/AI/code/chicken/frontend/api/user.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  ...
  getUserInfo: function getUserInfo(data) {
    return _request.default.get('/user/info', data);
  }
};
exports.default = _default;
